...
internal abstract class BaseTorrentServiceTests
{
    ...
    [
        new()
        {
            ...
            RefreshDate = new DateTime(2022, 10, 1, 12, 34, 56, 777, DateTimeKind.Utc),
            Name = "TV show name",
        ...
        new()
        {
            ...
            RefreshDate = new DateTime(2023, 11, 2, 11, 22, 33, 444, DateTimeKind.Utc),
            Name = "Movie name",
        ...
        new()
        {
            ...
            RefreshDate = new DateTime(2024, 12, 3, 10, 20, 30, 400, DateTimeKind.Utc),
