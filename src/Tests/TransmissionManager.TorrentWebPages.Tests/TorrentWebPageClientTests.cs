...
internal sealed class TorrentWebPageClientTests
{
    ...
    [Test]
    public async Task FindMagnetUriAsync_WhenWebPageContainsMagnet_FindsMagnetUri()
    {
    ...
    [Test]
    public async Task FindMagnetUriAsync_WhenWebPageDoesNotContainMagnet_FindsMagnetUri()
    {
    ...
    [Test]
    public void FindMagnetUriAsync_WhenWebPageDoesNotExist_ThrowsHttpRequestException()
    {
